...
<!--[if gt IE 8]><!-->
<html class="no-js" lang="en" manifest="">
<!--<![endif]-->
<head>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php bloginfo( 'template_url' ); ?>/assets/css/style.css?v=1" />

	<!-- Scripts -->

	<!-- Modernizr -->
	<script src="<?php bloginfo( 'template_url' ); ?>/assets/js/libs/modernizr-2.5.2.min.js?v=1"></script>
